  ...
  return (
    <Card>
      ...
      <CardContent className="grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-4">
        ...
        <ActionButton icon={Wallet} label="View Loan Details" href={`/finance/loans/${loanId}/details`} />
        <ActionButton icon={ListChecks} label="View EMI Schedule" href={`/finance/loans/${loanId}/schedule`} />
        <ActionButton icon={LineChart} label="View Forecast" href={`/finance/loans/${loanId}/forecast`} />
